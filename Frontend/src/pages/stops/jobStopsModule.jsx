...
import { Table, Breadcrumb, message, Input, Select, DatePicker, Row, Col, Button, Space, Tag, Tabs } from 'antd';
  ...
  return (
    <DashboardLayout>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div>
          <span className='textStyle-small' style={{ fontSize: 18 }}>Jobs Stops</span>
          <Breadcrumb style={{ margin: '2px 0' }}>
            <Breadcrumb.Item className='textStyle-small'>Home</Breadcrumb.Item>
            <Breadcrumb.Item className='textStyle-small'>Jobs Stops</Breadcrumb.Item>
          </Breadcrumb>
        </div>
        ...
        expandable={{
          expandedRowRender: (record) => (
            <Tabs defaultActiveKey="1">
              <Tabs.TabPane tab="Requested Stops" key="1">
                <Table
                  dataSource={stopDetails}
                  columns={[
                    { title: 'Stop ID', dataIndex: 'stopId', key: 'stopId' },
                    { title: 'Job ID', dataIndex: 'jobId', key: 'jobId' },
                    { title: 'City', dataIndex: ['city', 'name'], key: 'city' },
                    { title: 'Address', dataIndex: 'address', key: 'address' },
                    { title: 'Stop Type', dataIndex: 'stopType', key: 'stopType' },
                    { title: 'Stop Order', dataIndex: 'stopOrder', key: 'stopOrder' },
                    { title: 'Job Status', dataIndex: 'jobStatus', key: 'jobStatus' },
                  ]}
                />
              </Tabs.TabPane>
              <Tabs.TabPane tab="Map View" key="2">
          ...
          onExpandedRowsChange: (expandedRows, record) => {
