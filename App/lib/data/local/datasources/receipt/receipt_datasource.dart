...
class GoodsReceiptDataSource {
  ...
  final _receiptStore = intMapStoreFactory.store(DBConstants.STORE_NAME);
...
//  Future<Database> get _db async => await AppDatabase.instance.database;
  ...
  // Constructor
  GoodsReceiptDataSource(this._sembastClient);
  ...
  Future<int> count() async {
    return await _receiptStore.count(_sembastClient.database);
  }

  Future<List<GoodsReceipt>> getAllSortedByFilter(
